...
namespace Pluguin\Tests\Support;
...
class SupportServiceProviderTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $plugin = m::mock(Plugin::class)->makePartial();
        $one = new ServiceProviderForTestingOne($plugin);
        $one->boot();
        $two = new ServiceProviderForTestingTwo($plugin);
        $two->boot();
    }
